	...
	individual:[
      ...
      id: 'hcprems'
		},
		{
			...
			inputType:'text',
			unit:'$',
			tip:`<p>Include costs incurred over the course of the year for every member of your household, such as:<ul><li>Co-Pays</li><li>Prescriptions<sup>*</sup></li><li>Medical bills not covered by insurance, including:</li><ul><li>Dental, Vision, and Hearing expenses</li></ul><li>Emergency Room or Clinic Visits</li><li>Deductibles</li></ul><p><sup>*</sup>Note: the most you'll pay for prescriptions with I-1600 Universal Healthcare is $250 per adult per year.</p>`,
      showIcon:true,
      id:'yoopc'
		}
	],
