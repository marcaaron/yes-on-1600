			...
			return(
				<div className={`results ${this.props.resultStyle}`}>
					...
					<div className="contributions-box">
						...
						<div className="contributions-row">
							<p className='contributions-row-heading'>Investment Profit Contribution</p>
							<p className="contributions-row-result">${Math.floor(this.props.capitalGainsContribution / 12)}/mo</p>
						</div>
						<div className="contributions-row">
							<p className='contributions-row-heading'>Individual Premium<sup>*</sup></p>
			...
			return(
				<div className={`results ${this.props.resultStyle}`}>
					...
					<div className="contributions-box">
						...
						<div className="contributions-row">
							<p className='contributions-row-heading'>Per Adult Premium<sup>*</sup></p>
							<p className="contributions-row-result">${Math.floor(this.props.premium / 12)}/mo x {this.props.numberOfAdults}</p>
						</div>
						{(parseInt(this.props.sizeOfHousehold,10)-parseInt(this.props.numberOfAdults,10))>0 &&
							<div className="contributions-row">
								<p className='contributions-row-heading'>Per Child Premium</p>
								<p className="contributions-row-result">$0/mo x {parseInt(this.props.sizeOfHousehold,10)-parseInt(this.props.numberOfAdults,10)}</p>
							</div>
						}
					</div>
					<div className="middle-box">
					...
					<div className="total-box">
						...
						<p>(${Math.floor(parseInt(this.props.capitalGainsContribution,10) + parseInt(this.props.income,10) + (parseInt(this.props.premium,10)*parseInt(this.props.numberOfAdults,10)))}/yr)</p>
					</div>
					{this.props.savings>0 &&
						[
						<div className="middle-box">
